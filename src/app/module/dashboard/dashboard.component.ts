...
export class DashboardComponent implements OnInit {
  ...
  ebooks = [
    ...
    },
    {
      ...
      downloadUrl: 'http://localhost:59290/assets/image/sample.pdf',
    ...
    },
    {
      ...
      downloadUrl: 'https://www.hitbullseye.com/mba-prep/helpers/downloadpdffile.php?download=100-algebra-questions-ebook.pdf',
      description: 'The Lost World is a science fiction novel, featuring an expedition to a plateau in South America where prehistoric creatures still live.',
      category: 'Action & Adventure',
      categoryid:'2',
      publisher:'Quercus Publishing',
